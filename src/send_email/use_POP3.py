...
# 输入邮件地址, 口令和POP3服务器地址:
'''
email = 'pansiliang2007@126.com' #input('Email: ')
password = 'psl15971279885' #input('Password: ')
email = '425274873@qq.com' #input('Email: ')
password = 'L0ngshine@1' #input('Password: ')
使用SSL的通用配置如下：
接收邮件服务器：pop.qq.com，使用SSL，端口号995
发送邮件服务器：smtp.qq.com，使用SSL，端口号465或587
'''
email = '425274873@qq.com' #input('Email: ')
password = 'yyhokkqpmfcjbibe' #input('Password: ')
pop3_server = 'pop.qq.com' #input('POP3 server: ')

# 连接到POP3服务器:
#server = poplib.POP3(pop3_server, port=110)
server = poplib.POP3_SSL(pop3_server,port=995) # 创建SSL安全连接
